...
namespace XREX
{
	...
	void RenderingFactory::Initialize()
	{
		...
		std::vector<std::vector<uint32>> data1(1, std::vector<uint32>(1, 255));
		...
		std::vector<std::vector<uint32>> data2(1, std::vector<uint32>(1, 255));
		...
		std::vector<std::vector<uint32>> data3(1, std::vector<uint32>(1, 255));
